        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative mr-4 md:mr-8">
              <img src={rideFeedImage} alt="Ride Feed Screen" className="w-56 md:w-64 animate-float rounded-3xl shadow-uni-lg" />

              <div className="absolute -left-24 md:-left-44 top-16">
                <img src={getStartedImage} alt="Get Started Screen" className="w-48 md:w-56 rounded-3xl shadow-uni-lg" />
              </div>
            </div>
          </motion.div>
        </div>
